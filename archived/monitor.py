"""
Monitor Server - 实时监控与管理服务

主要功能：
1. 提供实时监控界面，展示服务状态和运行指标
2. 管理多个AI实例的运行状态和资源使用情况  
3. 提供流媒体管理功能，支持直播场景下的实时交互
4. 集成翻译服务，支持多语言实时翻译
5. WebSocket实时通信，确保低延迟的状态同步
6. 静态资源服务，支持监控面板的前端展示

注：此模块目前主要为直播场景设计，开源版本可能需要额外适配。
"""
import asyncio
import json
